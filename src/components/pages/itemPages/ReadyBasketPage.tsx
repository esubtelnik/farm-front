...
import ProductInBasketCarousel from "@/components/mainComponents/lists/ProductInBasketCarousel";

interface ReadyBasketPageProps {
   product: IReadyBasket;
   isLoading?: boolean;
}

const ReadyBasketPage: FC<ReadyBasketPageProps> = ({
   product,
   isLoading = false,
}) => {
   console.log(product);
   ...
   return (
      <div className="h-fit py-0 pb-6 md:py-6">
         <div className="flex flex-col md:flex-row gap-x-10 px-0 md:px-4 lg:px-0">
            ...
            <div className="flex flex-col p-3 md:p-0 md:gap-y-4 relative">
               ...
               <div className="flex sm:flex-row flex-col gap-y-2 justify-between my-7 md:my-0">
                  <div className="md:hidden ">
                     <span className="font-bold text-main-green text-lg">
                        {product.price} руб.
                     </span>{" "}
                     <span className="text-main-gray text-base ">/1 шт.</span>
                  </div>
         ...
         <div className="py-6 px-4 lg:px-0 space-y-4">
            <h2 className="text-main-green font-bold md:text-2xl text-lg">
               В корзину входят:
            </h2>
            <ProductInBasketCarousel products={product.products} />
         </div>

         {isReviewsOpen ? (
            <div id="reviews" className="px-6 space-y-5">
               <button
            ...
            <div className="flex flex-col md:flex-row bg-main-green/30 md:items-center gap-y-5 justify-between md:p-6 p-3">
               <div className="text-main-gray space-y-5">
                  ...
                  <p>
                     <span className="font-bold">Объем: </span>1 шт.
                  </p>
                  <p>
...
export default ReadyBasketPage;
